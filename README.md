...
The current version is implemented using Jakarta. Versions for Jakarta implementations typically start with _3.x_. If you are using Javax, please refer to [this link](https://github.com/softleader/specification-mapper/tree/main).
